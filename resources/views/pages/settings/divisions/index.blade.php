        ...
        <div class="flex items-start justify-between flex-wrap gap-5">
            ...
            <div>
                ...
                <p class="mt-3 text-gray-500 dark:text-gray-400">
                    ...
                    Kelola division, members, roles, dan permissions.
        ...
        <div class="space-y-6">
            ...
            <div
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <a
                        href="{{ route('division.roles.index', $division) }}"
                        class="inline-flex items-center justify-center rounded-xl border border-gray-300 bg-white px-5 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.05] transition">
                ...
                <div class="space-y-3">
                    ...
                    @forelse($division->roles as $role)
                        ...
                        <div
                            ...
                            @if(
                                $role->name !== 'Anggota' &&
                                $role->name !== 'Ketua Divisi'
                            )

                                <form
                                    action="{{ route('division.roles.destroy', [$division, $role]) }}"
                                    method="POST"
                    ...
                    @empty
                        ...
                        <div
                            ...
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                ...
                                Tambahkan role baru untuk division ini.
