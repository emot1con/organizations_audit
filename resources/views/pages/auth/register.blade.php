                            ...
                            <div class="space-y-6">
                                ...
                                <form method="POST" action="{{ route('register.process') }}">
                                    ...
                                    <div>
                                        <button
                                            type="submit"
                                            class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center rounded-lg px-4 py-3 mt-3 text-sm font-medium text-white transition">
                                            Sign Up
                                        </button>
                                    </div>
                                </div>
