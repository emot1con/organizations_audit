    ...
    @section('title', 'Sign In Organization Audit')
                    ...
                    <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                        <div>
                            <div class="mb-5 sm:mb-8">
                                ...
                                <a
                                    href="{{ route('home') }}"
                                    class="mt-4 inline-flex items-center gap-2 text-sm font-medium text-brand-500 transition hover:text-brand-600 dark:text-brand-400"
                                >
                            ...
                            <div>
                                ...
                                <form method="POST" action="{{ route('login.process') }}">
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <!-- Checkbox -forgot pass and remember me--> 
